...
namespace CallEngine.DAL.Migrations
{
    ...
    [Migration("20190219204336_CallParamsLogPath")]
    partial class CallParamsLogPath
    {
            ...
            modelBuilder.Entity("CallEngine.Models.BaseActionModel", b =>
                {
                    ...
                    b.HasIndex("NextActionAfterOpId");
            ...
            modelBuilder.Entity("CallEngine.Models.BaseActionModel", b =>
                {
                    ...
                    b.HasOne("CallEngine.Models.BaseActionModel", "NextActionAfterOp")
                        .WithMany()
                        .HasForeignKey("NextActionAfterOpId");
